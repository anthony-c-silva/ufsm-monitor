// Comando sysinfo: coleta o inventario local do probe (spec 4.1 / 6.6).
//
// Uso:
//
//	go run ./cmd/sysinfo
...
//
// Especifico de Linux (alvo: Raspberry Pi). Le /proc, /etc/resolv.conf e usa
// chamadas de rede da stdlib. Nenhum campo e fatal: em caso de erro o campo
// fica vazio. IMPORTANTE: o id do probe e PERMANENTE e nao deriva de IP/hostname
// (spec 4.1) -- aqui vem da flag/env; no agente vira de um arquivo persistente.
package main
...
const agentVersion = "0.1.0-prototype"

// SysinfoResult e o bloco "result" do inventario.
...
func main() {
	...
	started := time.Now()
	env := model.New(model.ProbeID(*probe), "sysinfo", "", started)
...
// primaryNet descobre o IP de saida, a interface correspondente e o MAC.
// O Dial UDP nao envia pacotes: apenas seleciona a rota de saida.
...
// defaultGateway le a rota padrao de /proc/net/route.
func defaultGateway() string {
	...
	for _, line := range lines {
		...
		// Destino 00000000 = rota padrao; Gateway em hex little-endian.
